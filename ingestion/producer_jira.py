...
TOPIC = os.getenv("KAFKA_TOPIC_JIRA", "jira-events")

# ── realistic Atlassian-style data ────────────────────────────
TEAMS = ["Platform Engineering", "Jira Cloud Core", "Confluence Content",
         "Bitbucket DevOps", "Data & Analytics", "Mobile Apps"]

EVENT_TYPES = ["issue_created", "issue_updated", "issue_closed",
               "comment_added", "ai_assist", "sprint_started"]

PRIORITIES = ["Low", "Medium", "High", "Critical"]

# ── generate one realistic Jira event ─────────────────────────
def generate_jira_event():
    ...
    return {
        ...
        "project_key":      fake.bothify(text="??-####").upper(),
...
print("🚀 AtlasPulse — Jira producer started")
